...
SWIFT_CLASS("_TtC8PlaceMap11AppDelegate")
@interface AppDelegate : UIResponder <UIApplicationDelegate, UISplitViewControllerDelegate>
@property (nonatomic, strong) UIWindow * _Nullable window;
@property (nonatomic, strong) PlaceDatabase * _Nonnull placeDB;
...
- (BOOL)splitViewControllerWithSplitViewController:(UISplitViewController * _Nonnull)splitViewController collapseSecondaryViewController:(UIViewController * _Nonnull)secondaryViewController ontoPrimaryViewController:(UIViewController * _Nonnull)primaryViewController;
...
SWIFT_CLASS("_TtC8PlaceMap24MapDisplayViewController")
...
SWIFT_CLASS("_TtC8PlaceMap13PlaceDatabase")
@interface PlaceDatabase : NSObject
@property (nonatomic, copy) NSArray<NSDictionary<NSString *, NSString *> *> * _Nonnull places;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)prefectureOf:(NSString * _Nonnull)pref;
@end
...
SWIFT_CLASS("_TtC8PlaceMap23PlaceListViewController")
